...
const GridDistortion: React.FC<GridDistortionProps> = ({
  ...
  useEffect(() => {
    ...
    // Attach to window to work even with pointer-events-none on parent
      ...
      for (let i = 0; i < size; i++) {
        for (let j = 0; j < size; j++) {
          ...
          if (distSq < maxDist * maxDist) {
            ...
            data[index] += strength * 1500 * mouseState.vX * power;
            data[index + 1] -= strength * 1500 * mouseState.vY * power;
          }
        }
      }
